...
public class PaymentController {
    ...
    public ApiResponse<PaymentDTO> payCallbackHandler(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (status.equals("00")) {
            ...
            if(platform.equals("web")) response.sendRedirect("http://focodo-web-s3.s3-website-ap-northeast-1.amazonaws.com/CompleteOrder?id_order=" + id_order);
            ...
            if(platform.equals("web")) response.sendRedirect("http://focodo-web-s3.s3-website-ap-northeast-1.amazonaws.com/ErrorOrder");
